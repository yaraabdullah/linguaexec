...
const TONE_STYLES: Record<string, { bg: string; border: string; text: string }> = {
  ...
  Polite:   { bg: "rgba(16,185,129,0.10)",  border: "rgba(16,185,129,0.25)", text: "#6ee7b7" },
        ...
        <span className="flex items-end gap-[2px] h-4">
          {[1,2,3].map(i => (
            <span key={i} className="w-[3px] rounded-full"
              style={{ background: "#34d399", height: `${i*4+4}px`,
    ...
    <div className="min-h-screen" style={{ background: "#080d1a" }}>
      ...
      <nav className="glass border-b sticky top-0 z-10" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <span className="font-bold" style={{ background: "linear-gradient(135deg, #10b981, #059669)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            What Should I Say?
          </span>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        {/* Input area */}
        <div className="glass rounded-2xl p-6 mb-6" style={{ border: "1px solid rgba(16,185,129,0.2)" }}>
          <label className="block text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: "#34d399" }}>
